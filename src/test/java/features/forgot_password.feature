Feature: As user I should be able
...
Scenario: User with email and phone number
  ...
  Scenario: User should be able to land in Forgot Password screen with email and phone number

     User sees reset password screen
...
Scenario: verify sms forgot password (may be available through google voice api)



  Scenario: verify login with old password after password was reseted
